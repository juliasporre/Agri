AgriApp.controller('privateMessagesCtrl', function($scope, model, $routeParams){
...
app.onMessageArrived = function(message) {
	...
	if(o.nick!=undefined){ //Ska läggas till i privata meddelanden
      ...
      console.log(messNick);
			text.innerHTML= '<div class="messageBox" id="msgBox"><div class="col-xs-8"><div class="nameBox">' + o.nick + '</div></div><div class="col-xs-4"><div class="timeStamp">' + actualTime + '</div></div><div>' + o.msg + '</div></div>';
